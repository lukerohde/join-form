  ...
  private
    ...
    def set_subscription
      ...
      if @subscription.nil?
        ...
        @subscription.signature_vector = "" unless current_person.present? || params[:with_sig] == 'true' # users can't sign, but do see the signature; non-users always have to sign and don't see the sig
      end
    end
